...
public class Sorteio_Quadra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sorteio_quadra);
    }
    ...
    public void resultadodacomparacao(View view){
        if(listadenumeros.size() != 0){
            ...
            if(tempjgum != null){
                ...
                Intent intent = new Intent(this, Quadra_VariosResultados.class);
                ...
                Intent intent = new Intent(this, Quadra_Resultado.class);
