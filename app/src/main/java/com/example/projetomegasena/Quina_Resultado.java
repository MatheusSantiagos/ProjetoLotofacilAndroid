...
public class Quina_Resultado extends AppCompatActivity {
    int i,cont;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quina_resultado);
    ...
    public void compar (View view){
        ...
        //declara os textviews presentes para o carregamento de valores
        ...
        TextView numerosselecionados5 = findViewById(R.id.numsel05);
        ...
        TextView numerosdosorteio5 = findViewById(R.id.numsort05);
        ...
        numerosselecionados5.setText("" +valorescheck2.get(4));
        ...
        numerosdosorteio5.setText("" +listadenumeros2.get(4));
