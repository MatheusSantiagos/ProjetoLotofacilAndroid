...
public class Quina_Varios_Resultados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quina_varios_resultados);
    ...
    public void Alterador(View view){
        ...
        TextView numeroesc5 = findViewById(R.id.textView30);
        ...
        TextView numerosorte5 = findViewById(R.id.textView37);
        ...
        if(jogonum == 1){
            ...
            numerosorte5.setText(""+listadenumeros2.get(4));
            if(cont == 5){
                victory();
            }else{
                defeat();
