...
public class Selecao_Quadra extends AppCompatActivity {
    ArrayList<String> valorescheck = new ArrayList<>(4);
    ArrayList<String> valorescheckjogo1 = new ArrayList<>(4);
    ArrayList<String> valorescheckjogo2 = new ArrayList<>(4);
    ArrayList<String> valorescheckjogo3 = new ArrayList<>(4);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selecao_quadra);
        Toast.makeText(this, "Selecione Quatro Numeros", Toast.LENGTH_SHORT).show();
        ...
        //desabilita checkboxes quando chega a 4 marcados
        ...
        public void criarnovojogo (View view){
            ...
            if (jogos == 1 && valorescheck.size() == 4) {
            ...
            if (jogos == 2 && valorescheck.size() == 4) {
            ...
            if (jogos == 3 && valorescheck.size() == 4) {
            ...
            if (valorescheck.size() < 4 && valorescheck.size() >= 4) {
        ...
        public void teladesorteio (View view){
            ...
            if (valorescheck.size() == 4) {
                Intent intent = new Intent(this, Sorteio_Quadra.class);
